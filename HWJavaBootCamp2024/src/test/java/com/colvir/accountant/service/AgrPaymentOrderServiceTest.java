...
class AgrPaymentOrderServiceTest {
    ...
    void generateAgrPmtOrder_success() {
        ...
        when(agrPaymentOrderRepository.save(any())).thenReturn(any());
    ...
    void calculate() {
        ...
        verify(departmentRepository, times(2)).findById(any());
        verify(employeeRepository, times(3)).findByIdAndIdDept(any(), any());
